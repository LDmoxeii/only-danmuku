...
CREATE TABLE `customer_action`
    ...
    `action_type`    tinyint(1)                                                   NOT NULL COMMENT '行为类型 @E=0:Like_COMMENT:评论喜欢点赞|1:HATE_COMMENT:讨厌评论|2:LIKE_VIDEO:视频点赞|3:FAVORITE_VIDEO:视频收藏 4:COIN_VIDEO:视频投币@T=ActionType',
