...
CREATE TABLE video_file_draft
    ...
    `update_type`     tinyint(4)                                                    NULL DEFAULT NULL COMMENT '更新类型 @E=0:NO_UPDATE:无更新|1:HAS_UPDATE:有更新;@T=UpdateType',
    `transfer_result` tinyint(4)                                                    NULL DEFAULT NULL COMMENT '转码结果 @E=0:TRANSCODING:转码中|1:SUCCESS:转码成功|2:FAILED:转码失败;@T=TransferResult',
