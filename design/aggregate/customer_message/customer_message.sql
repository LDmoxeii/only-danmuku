...
CREATE TABLE `customer_message`
    ...
    `message_type`    tinyint(1)                                                   NULL DEFAULT NULL COMMENT '消息类型 @E=0:SYSTEM_MESSAGE:系统消息|1:COMMENT_REPLY:评论回复|2:VIDEO_DYNAMIC:视频动态|3:PRIVATE_MESSAGE:私信消息|4:ACTIVITY_NOTICE:活动通知|5:OTHER_MESSAGE:其他消息;@T=MessageType',
    `send_subject_id` varchar(10) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL DEFAULT NULL COMMENT '发送主体ID',
    `read_type`       tinyint(1)                                                   NULL DEFAULT NULL COMMENT '读取状态 @E=0:UNREAD:未读|1:READ:已读;@T=ReadType',
