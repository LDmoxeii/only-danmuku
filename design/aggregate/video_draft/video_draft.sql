...
CREATE TABLE video_file_draft
    ...
    `customer_id`     bigint                                                        NOT NULL COMMENT '用户ID',
    `video_id` bigint NOT NULL COMMENT '视频ID@@Ref=video_draft',
    ...
    ENGINE = InnoDB
    CHARACTER SET = utf8mb4
    COLLATE = utf8mb4_general_ci COMMENT = '视频文件信息;@P=video_draft'
    ROW_FORMAT = DYNAMIC;

-- ----------------------------
-- Test data for video_draft
-- ----------------------------
INSERT INTO video_draft (id, video_cover, video_name, customer_id, p_category_id, category_id, status,
...
-- ----------------------------
INSERT INTO video_file_draft (id, upload_id, customer_id, video_id, file_index, file_name, file_size,
