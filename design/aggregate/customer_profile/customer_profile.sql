...
CREATE TABLE `customer_profile`
    ...
    `sex`                 tinyint(1)                                                    NULL     DEFAULT NULL COMMENT '性别 @E=0:FEMALE:女|1:MALE:男|2:UNKNOWN:未知;@T=SexType',
    ...
    `theme`               tinyint(1)                                                    NOT NULL DEFAULT 1 COMMENT '主题 @E=1:LIGHT:浅色主题|2:DARK:深色主题|3:SYSTEM:跟随系统;@T=ThemeType',
