...
import edu.only4.danmuku.adapter.domain.translation.customer_action.ActionTypeTranslation.Companion.ACTION_TYPE_CODE_TO_DESC
 ...
 */
@TranslationType(type = ACTION_TYPE_CODE_TO_DESC)
@Component
class ActionTypeTranslation :
    TranslationInterface<String>, BatchTranslationInterface<String> {

    companion object {
        const val ACTION_TYPE_CODE_TO_DESC = "action_type_code_to_desc"
    }
