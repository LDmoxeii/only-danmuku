...
import edu.only4.danmuku.adapter.domain.translation.video.RecommendTypeTranslation.Companion.RECOMMEND_TYPE_CODE_TO_DESC
 ...
 */
@TranslationType(type = RECOMMEND_TYPE_CODE_TO_DESC)
@Component
class RecommendTypeTranslation :
    TranslationInterface<String>, BatchTranslationInterface<String> {

    companion object {
        const val RECOMMEND_TYPE_CODE_TO_DESC = "recommend_type_code_to_desc"
    }
