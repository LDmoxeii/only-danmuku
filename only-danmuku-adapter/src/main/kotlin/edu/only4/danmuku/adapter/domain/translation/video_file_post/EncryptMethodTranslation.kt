...
import edu.only4.danmuku.adapter.domain.translation.video_file_post.EncryptMethodTranslation.Companion.ENCRYPT_METHOD_CODE_TO_DESC
...
@Component
class EncryptMethodTranslation :
    ...
    override fun translation(key: Any, other: String): String? {
        ...
        return EncryptMethod.valueOfOrNull(code)?.desc
    }
    ...
    override fun translationBatch(keys: Collection<Any>, other: String): Map<Any, String?> {
        ...
        val codeToDesc: Map<Int, String?> = codes.associateWith { c ->
            EncryptMethod.valueOfOrNull(c)?.desc
        }
