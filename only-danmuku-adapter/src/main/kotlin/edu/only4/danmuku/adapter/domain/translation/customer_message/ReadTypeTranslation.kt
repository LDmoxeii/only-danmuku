...
import edu.only4.danmuku.adapter.domain.translation.customer_message.ReadTypeTranslation.Companion.READ_TYPE_CODE_TO_DESC
 ...
 */
@TranslationType(type = READ_TYPE_CODE_TO_DESC)
@Component
class ReadTypeTranslation :
    TranslationInterface<String>, BatchTranslationInterface<String> {

    companion object {
        const val READ_TYPE_CODE_TO_DESC = "read_type_code_to_desc"
    }
