...
@Constraint(validatedBy = [UniqueVideoHlsEncryptKeyVideoPostIdFileIndexKeyIdKeyVersionQuality.Validator::class])
@MustBeDocumented
annotation class UniqueVideoHlsEncryptKeyVideoPostIdFileIndexKeyIdKeyVersionQuality(
    ...
    class Validator : ConstraintValidator<UniqueVideoHlsEncryptKeyVideoPostIdFileIndexKeyIdKeyVersionQuality, Any> {
        ...
        override fun initialize(constraintAnnotation: UniqueVideoHlsEncryptKeyVideoPostIdFileIndexKeyIdKeyVersionQuality) {
        ...
        override fun isValid(value: Any?, context: ConstraintValidatorContext): Boolean {
            ...
            val result = runCatching {
                Mediator.queries.send(
                    UniqueVideoHlsEncryptKeyVideoPostIdFileIndexKeyIdKeyVersionQualityQry.Request(
