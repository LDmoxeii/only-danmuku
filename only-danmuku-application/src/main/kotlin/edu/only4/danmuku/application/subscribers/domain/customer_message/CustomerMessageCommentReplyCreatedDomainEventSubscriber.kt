 ...
 */
@Service
class CustomerMessageCommentReplyCreatedDomainEventSubscriber {

    @EventListener(CustomerMessageCommentReplyCreatedDomainEvent::class)
    fun on(event: CustomerMessageCommentReplyCreatedDomainEvent) {
