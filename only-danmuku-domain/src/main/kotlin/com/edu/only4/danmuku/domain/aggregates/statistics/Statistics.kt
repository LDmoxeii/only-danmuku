...
class Statistics (
     ...
     * tinyint(1)
     */
    @Convert(converter = com.edu.only4.danmuku.domain.aggregates.statistics.enums.StatisticsDataType.Converter::class)
    @Column(name = "`data_type`")
    var dataType: com.edu.only4.danmuku.domain.aggregates.statistics.enums.StatisticsDataType = com.edu.only4.danmuku.domain.aggregates.statistics.enums.StatisticsDataType.valueOf(0),
