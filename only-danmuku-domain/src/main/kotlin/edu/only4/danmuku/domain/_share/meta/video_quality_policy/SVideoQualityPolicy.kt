...
class SVideoQualityPolicy(
    ...
    companion object {
        ...
        */
         ...
         */
        @JvmStatic
        fun predicate(builder: PredicateBuilder<SVideoQualityPolicy>, distinct: Boolean): JpaPredicate<VideoQualityPolicy> {
            return JpaPredicate.bySpecification(VideoQualityPolicy::class.java, specify(builder, distinct))
        }
        ...
        fun predicate(
            builder: PredicateBuilder<SVideoQualityPolicy>,
            orderBuilders: List<OrderBuilder<SVideoQualityPolicy>>,
        ): JpaPredicate<VideoQualityPolicy> {
            return JpaPredicate.bySpecification(VideoQualityPolicy::class.java, specify(builder, false, orderBuilders))
        }
        ...
        fun predicate(
            ...
            return JpaPredicate.bySpecification(VideoQualityPolicy::class.java, specify(builder, distinct, orderBuilders))
        }
