...
class SUserAbnormalOperationLog(
    ...
    companion object {
        ...
        */
         ...
         */
        @JvmStatic
        fun predicate(builder: PredicateBuilder<SUserAbnormalOperationLog>, distinct: Boolean): JpaPredicate<UserAbnormalOperationLog> {
            return JpaPredicate.bySpecification(UserAbnormalOperationLog::class.java, specify(builder, distinct))
        }
        ...
        fun predicate(
            builder: PredicateBuilder<SUserAbnormalOperationLog>,
            orderBuilders: List<OrderBuilder<SUserAbnormalOperationLog>>,
        ): JpaPredicate<UserAbnormalOperationLog> {
            return JpaPredicate.bySpecification(UserAbnormalOperationLog::class.java, specify(builder, false, orderBuilders))
        }
        ...
        fun predicate(
            ...
            return JpaPredicate.bySpecification(UserAbnormalOperationLog::class.java, specify(builder, distinct, orderBuilders))
        }
     ...
     * 异常类型
     */
    val opType: Field<AbnormalOpType> by lazy {
