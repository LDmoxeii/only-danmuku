 ...
 */
class SVideoHlsAbrVariant(
    private val root: Path<VideoHlsAbrVariant>,
    ...
    companion object {
         ...
         */
        @JvmStatic
        fun specify(builder: PredicateBuilder<SVideoHlsAbrVariant>): Specification<VideoHlsAbrVariant> {
         ...
         */
        @JvmStatic
        fun specify(builder: PredicateBuilder<SVideoHlsAbrVariant>, distinct: Boolean): Specification<VideoHlsAbrVariant> {
        ...
        @JvmStatic
        fun specify(
            builder: PredicateBuilder<SVideoHlsAbrVariant>,
            vararg orderBuilders: OrderBuilder<SVideoHlsAbrVariant>,
        ): Specification<VideoHlsAbrVariant> {
        ...
        fun specify(
            builder: PredicateBuilder<SVideoHlsAbrVariant>,
            orderBuilders: List<OrderBuilder<SVideoHlsAbrVariant>>,
        ): Specification<VideoHlsAbrVariant> {
        ...
        */
         ...
         */
        @JvmStatic
        fun specify(specifier: SchemaSpecification<VideoHlsAbrVariant, SVideoHlsAbrVariant>): Specification<VideoHlsAbrVariant> {
            return Specification { root, criteriaQuery, criteriaBuilder ->
                val schema = SVideoHlsAbrVariant(root, criteriaBuilder)
        ...
        */
        ...
        fun <E> subquery(
            resultClass: Class<E>,
            selectBuilder: ExpressionBuilder<SVideoHlsAbrVariant, E>,
            predicateBuilder: PredicateBuilder<SVideoHlsAbrVariant>,
        ...
        fun <E> subquery(
            resultClass: Class<E>,
            subqueryConfigure: SubqueryConfigure<E, SVideoHlsAbrVariant>,
            criteriaBuilder: CriteriaBuilder,
            criteriaQuery: CriteriaQuery<*>,
        ): Subquery<E> {
            val sq = criteriaQuery.subquery(resultClass)
            val root = sq.from(VideoHlsAbrVariant::class.java)
            val schema = SVideoHlsAbrVariant(root, criteriaBuilder)
    ...
    fun _root(): Path<VideoHlsAbrVariant> = root
    ...
    /**
     * Master 中的 BANDWIDTH（bps，视频+音频估算）
     */
    ...
    /**
     * 关联: ManyToOne - VideoFilePost
     */
    val videoFilePost: Field<Any> by lazy {
        Field(root.get("videoFilePost"), criteriaBuilder)
    }
     ...
     * @return
     */
    fun spec(builder: PredicateBuilder<SVideoHlsAbrVariant>): Predicate {
