package edu.only4.danmuku.domain.aggregates.video_hls_quality_auth.enums
 ...
 * @date 2025/11/26
 */
@Aggregate(aggregate = "VideoHlsQualityAuth", name = "QualityAuthPolicy", type = "enum", description = "")
